...
const Whitepaper: NextPage = () => {
  ...
  return (
    <div className="page mobile-page">
      ...
      <h1>About</h1>
        <p className="para">
          This registrar allows users to claim names by using the reserve function. One of these names can then be set as your primary name using the setAddress function, which the contract will resolve to your address. There are also read functions that allow one to see the resolved name associated with an address,
