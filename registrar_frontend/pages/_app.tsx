        ...
        <div className="provider">
          <div className="header">
            ...
            <div className="footer">
              Made with ❤️ by Mason Keresty<br/>Consider donating to <a href="https://etherscan.io/address/0x3d0768da09ce77d25e2d998e6a7b6ed4b9116c2d" target="_blank" rel="noopener noreferrer">Linagee</a>
            </div>
        </div>
      </ThemeProvider>
